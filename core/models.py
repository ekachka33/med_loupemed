...
class ServicePriceItem(models.Model):
    ...
    unit = models.CharField(
        max_length=50,
        blank=True,
        verbose_name="Единица измерения ('за сеанс')"
    )
...
class Appointment(models.Model):
    ...
    def is_upcoming_appointment(self):
        ...
        return datetime.timedelta(seconds=0) <= time_difference <= datetime.timedelta(hours=24)
...
class MedicalRecord(models.Model):
    ...
    title = models.CharField(
        max_length=255,
        verbose_name="Название документа/анализа",
        blank=True,
        null=True
    )
