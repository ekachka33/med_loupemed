    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='about_us/', verbose_name='Изображение для страницы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number_alt', models.CharField(blank=True, max_length=20, null=True, verbose_name='Дополнительный номер телефона')),
                ('email_main', models.EmailField(max_length=254, verbose_name='Основной Email')),
                ('email_alt', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Дополнительный Email')),
                ('work_hours', models.CharField(help_text='ПН-ПТ 9:00-18:00', max_length=255, verbose_name='Часы работы')),
