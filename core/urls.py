...
urlpatterns = [
    ...
    path(
        "make-appointment/",
        views.MakeAppointmentView.as_view(),
    ...
    path(
        "doctor/schedule/", views.DoctorScheduleView.as_view(), name="doctor_schedule"
    ),
    path(
        "get-services-for-doctor/",
        views.get_services_for_doctor,
        name="get_services_for_doctor",
    ),
    path(
        "profile/my-appointments/",
        UserAppointmentsView.as_view(),
